        ...
        <table>
          ...
          >
            ...
            {visible.map(d => {
              ...
              return (
                <tr key={id}>
                  <td className="ro">{d.brand}</td>
                  <td className="ro">{d.pattern}</td>
                  <td className="ro">{d.pcode}</td>
                  <td className="ro">{d.size}</td>
                  <td className="ro">{d.pr}</td>
                  <td>
                    <input key={ek('dot')} className="edit" data-id={id} data-f="dot"
                      defaultValue={d.dot} onInput={e => onCellInput(e, id, 'dot')} />
                  </td>
                  <td className="ro">{krw(d.factory)}</td>
                  <td>
                  ...
                  <td className="br">{pct(d.dc_rate)}</td>
                  <td className="bs">{krw(d.dc_price)}</td>
                  <td className="bt">
                    <div className="tbox">
